...
class CredentialSchemaDispatcherIT {

    @Test
    void missingConfigIdFromTypeLeadsToUnknownFormat() throws Exception {
        ...
        var credential = new DualFormatFlowTestSupport().readFixture("fixtures/dome/label-2.json");
